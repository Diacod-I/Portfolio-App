        ...
        profile.map((data) => (
          <div key={data._id}>
            <section className="grid lg:grid-cols-2 grid-cols-1 gap-x-6 justify-items-center">
              <div className="order-2 lg:order-none">
                <h1 className="lg:text-5xl text-4xl lg:leading-tight basis-1/2 font-bold mb-8">
                  I&apos;m {data.fullName},<br />Artificial Intelligence Engineer.
                </h1>
            ...
            <section className="mt-24 max-w-2xl">
              <h2 className="font-semibold text-4xl mb-4">Languages</h2>
              <p className="text-zinc-400 max-w-lg">
                The programming languages I work with are, in no particular order, the following:
              </p>
            ...
            <section className="mt-24 max-w-2xl">
              ...
              <ul className="flex flex-wrap items-center gap-3 mt-8">
                {data.frameworks.map((framework, id2) => (
                  <li
                    key={id2}
                    className="bg-[#1d1d20] border border-transparent hover:border-zinc-700 rounded-md px-2 py-1"
                  >
